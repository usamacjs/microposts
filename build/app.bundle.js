...
// Get Posts
function getPosts() {
  _http.http.get('http://localhost:8080/posts').then(function (data) {
...
function submitPost() {
  ...
  var data = {
    ...
    if (id === '') {
      // Create Post
      _http.http.post('http://localhost:8080/posts', data).then(function (data) {
      ...
      // Update Post
      _http.http.put('http://localhost:8080/posts/' + id, data).then(function (data) {
...
function deletePost(e) {
  if (e.target.parentElement.classList.contains('delete')) {
    ...
    if (confirm('Are you sure?')) {
      _http.http.delete('http://localhost:8080/posts/' + id).then(function (data) {
